...
- [Payments and Balance](06-payments-and-balance.mdx) - How to purchase plans and check credits
- [Validation of Requests](08-validation-of-requests.mdx) - How agents validate tokens (for builders)
