...
- [Payments and Balance](payments-and-balance.mdx) - How to purchase plans and check credits
- [Validation of Requests](validation-of-requests.mdx) - How agents validate tokens (for builders)
