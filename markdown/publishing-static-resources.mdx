...
See [Validation of Requests](validation-of-requests.mdx) for implementation details.
...
- [Agents](agents.mdx) - Agent registration fundamentals
- [Payment Plans](payment-plans.mdx) - Configure pricing for resource access
- [Validation of Requests](validation-of-requests.mdx) - Verify access tokens for downloads
