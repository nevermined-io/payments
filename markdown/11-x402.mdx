...
- [Querying an Agent](07-querying-an-agent.mdx) - How subscribers use X402 tokens
- [Validation of Requests](08-validation-of-requests.mdx) - How agents verify and settle
- [MCP Integration](09-mcp-integration.mdx) - Automatic X402 handling in MCP
- [A2A Integration](10-a2a-integration.mdx) - Automatic X402 handling in A2A
