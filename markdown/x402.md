...
- [Querying an Agent](querying-an-agent.md) - How subscribers use X402 tokens
- [Validation of Requests](validation-of-requests.md) - How agents verify and settle
- [MCP Integration](mcp-integration.md) - Automatic X402 handling in MCP
- [A2A Integration](a2a-integration.md) - Automatic X402 handling in A2A
