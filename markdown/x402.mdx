...
- [Querying an Agent](querying-an-agent.mdx) - How subscribers use X402 tokens
- [Validation of Requests](validation-of-requests.mdx) - How agents verify and settle
- [MCP Integration](mcp-integration.mdx) - Automatic X402 handling in MCP
- [A2A Integration](a2a-integration.mdx) - Automatic X402 handling in A2A
